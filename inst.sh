...
useradd -G audio,disk,input,network,power,seat,storage,tty,users,video,wheel -m adamina
sleep 1s
...
echo -e "adamina hard nofile 1048576\nadamina soft nofile 1048576" > /etc/security/limits.conf
sleep 1s
...
sleep 0.1s
su adamina -c "mkdir -p /home/adamina/.config/dinit.d/boot.d"
sleep 0.1s
ln -s /etc/dinit.d/user/dbus /home/adamina/.config/dinit.d/boot.d/dbus
sleep 0.1s
ln -s /etc/dinit.d/user/pipewire /home/adamina/.config/dinit.d/boot.d/pipewire
sleep 0.1s
ln -s /etc/dinit.d/user/pipewire-pulse /home/adamina/.config/dinit.d/boot.d/pipewire-pulse
sleep 0.1s
ln -s /etc/dinit.d/user/wireplumber /home/adamina/.config/dinit.d/boot.d/wireplumber
sleep 1s
...
sleep 0.1s
su adamina -c 'mkdir -p /home/adamina/.local/share/ALVR-Launcher/installations/Nightly'
sleep 0.1s
su adamina -c 'curl -sL https://github.com/alvr-org/ALVR/releases/latest/download/alvr_launcher_linux.tar.gz -o /home/adamina/.local/share/ALVR-Launcher/alvr.tar.gz'
sleep 0.1s
su adamina -c 'tar -xzf /home/adamina/.local/share/ALVR-Launcher/alvr.tar.gz -C /home/adamina/.local/share/ALVR-Launcher'
sleep 0.1s
su adamina -c 'mv "/home/adamina/.local/share/ALVR-Launcher/alvr_launcher_linux/ALVR Launcher" /home/adamina/.local/share/ALVR-Launcher/ALVR'
sleep 0.1s
su adamina -c 'rm /home/adamina/.local/share/ALVR-Launcher/alvr.tar.gz'
sleep 0.1s
su adamina -c 'rm -r /home/adamina/.local/share/ALVR-Launcher/alvr_launcher_linux'
sleep 0.1s
su adamina -c 'curl -sL https://github.com/alvr-org/ALVR-nightly/releases/latest/download/alvr_streamer_linux.tar.gz -o /home/adamina/.local/share/ALVR-Launcher/alvrNightly.tar.gz'
sleep 0.1s
su adamina -c 'tar -xzf /home/adamina/.local/share/ALVR-Launcher/alvrNightly.tar.gz -C /home/adamina/.local/share/ALVR-Launcher/installations/Nightly'
sleep 0.1s
su adamina -c 'rm /home/adamina/.local/share/ALVR-Launcher/alvrNightly.tar.gz'
sleep 0.1s
echo -e '#!/bin/bash\nclear\necho "Checking for RTSP Proton updates..."\nrepo=$(curl -sL https://github.com/SpookySkeletons?tab=repositories | grep -iom 1 "proton.\+rtsp")\nrtspVer=$(curl -sL https://github.com/SpookySkeletons/$repo/releases/latest | grep -iom 1 "proton.\+spo" | sed "s/......$//")\ninstRTSP=$(ls /home/adamina/.local/share/Steam/compatibilitytools.d | grep -iom 1 "proton.\+")\necho -e "Latest RTSP Proton: $rtspVer\\nInstalled RTSP Proton: $instRTSP\\n\\nFetching latest ALVR..."\nalvrVer=$(curl -sL https://github.com/alvr-org/ALVR-nightly/releases/latest | grep -iom 1 "ALVR.\+alvr-o" | sed "s/.........$//")\necho -e "Latest ALVR: $alvrVer\\nInstalled ALVR can be found in dashboard.\\n\\nLaunching ALVR..."\n/home/adamina/.local/share/ALVR-Launcher/ALVR &\necho "ALVR launched, you can close this terminal window."' > /usr/local/bin/alvr
sleep 0.1s
chmod +x /usr/local/bin/alvr
sleep 0.1s
su adamina -c 'mkdir -p /home/adamina/.local/share/Steam/compatibilitytools.d'
sleep 0.1s
su adamina -c 'curl -sL https://github.com/SpookySkeletons/$(curl -sL https://github.com/SpookySkeletons?tab=repositories | grep -iom 1 "proton.\+rtsp")/releases/download/proton-rtsp-11.0-20260609-1/proton-rtsp-11.0-20260609-1.tar.gz -o /home/adamina/.local/share/Steam/compatibilitytools.d/rtsp.tar.gz'
sleep 0.1s
su adamina -c 'tar -xzf /home/adamina/.local/share/Steam/compatibilitytools.d/rtsp.tar.gz -C /home/adamina/.local/share/Steam/compatibilitytools.d'
sleep 0.1s
su adamina -c 'rm /home/adamina/.local/share/Steam/compatibilitytools.d/rtsp.tar.gz'
sleep 1s

echo "Running some commands as user..."
su adamina -c "xdg-user-dirs-update"
sleep 0.1s
su adamina -c 'echo -e "xfce4-panel &\nxfce4-screensaver &\nxfdesktop &\nblueman-applet &\nconnman-gtk --tray &\nthunar --daemon &\nexec xfwm4" > /home/adamina/.xinitrc'
sleep 0.1s
su adamina -c 'echo -e "[[ -f ~/.bashrc ]] && . ~/.bashrc\nstartx" > /home/adamina/.bash_profile'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/xfce4-taskmanager.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/io.github.ilya_zlobintsev.LACT.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/mpv.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/org.xfce.mousepad.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/xfce4-terminal.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/org.shotcut.Shotcut.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/gimp.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/org.prismlauncher.PrismLauncher.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/steam.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'cp /usr/share/applications/org.qutebrowser.qutebrowser.desktop /home/adamina/Desktop'
sleep 0.1s
su adamina -c 'chmod -R +x /home/adamina/Desktop
